...
import { closeAlert, closeConfirm, closePrompt, createDialogsState, DialogsStateContext } from "../utilities/dialogs";
...
const Prompt = (): JSX.Element => {
	...
	return (<Overlay id={"prompt"} classes={["dialog"]} isDialog={true} title={null} level={4} validateOnClick={() => closePrompt(input.current!.value)}>
